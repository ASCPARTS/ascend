...
switch ($strProcess) {
    ...
    case 'Filter':
        ...
        $strFilter .= '<div class="MainContainer">';
        $strFilter .= '<form name="filter" method="post">';
        $strFilter .= '<div class="row" >';
        ...
        $strFilter .= '<select id="cbo1" name="intFamily">';
        ...
        $jsnPhpScriptResponse['htmlform'] = $strFilter;
