...
switch ($strProcess) {
    case 'salesProjection':
        ...
        elseif($intProjection==1){
            $strSql="select intId , strDescription  
        FROM catZone WHERE strStatus='A';";
        ...
        ORDER BY nMonth;";
            ...
            $strSql="select intId , strName  
        FROM tblUser WHERE intRoll = (SELECT intId FROM catDepartment where strName='ventas') ORDER BY 2;";
