...
<head>
    ...
    <style>
        ...
        input[type=text]{
            ...
            background-image: url('pixel_1E202C.png'), url('input_img.png'), url('img/pixel_00B8FE.png');
            background-repeat: repeat-y, no-repeat, no-repeat;
            background-position: 26px, 0, 0;
            background-size: auto, auto, 26px 25px;
        }
    ...
    <tbody>
        <tr style="height: 50px">
            <td colspan="3" style="background-color: #050409; padding: 0 0 0 0">
                <div class="altMenuLeft" style="background-image: url('img/logo_h_byn_128.png'); background-repeat: no-repeat; background-position: center center; width: 152px !important; cursor: default; "></div>
